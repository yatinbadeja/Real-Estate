   ...
   let Card = [
    ...
    <>
      ...
      <div className='App'>
        ...
        <div className='row1'>
           <CardJs  Image={Card[0].Image}
              Price={Card[0].Price}
              Content={Card[0].Content} 
           ></CardJs>
            <CardJs  Image={Card[1].Image}
              Price={Card[1].Price}
              Content={Card[1].Content} 
            ></CardJs>
            <CardJs  Image={Card[2].Image}
              Price={Card[2].Price}
       ...
       <div className='row2'>
            <CardJs  Image={Card[3].Image}
              Price={Card[3].Price}
              Content={Card[3].Content} 
            ></CardJs>
            <CardJs  Image={Card[4].Image}
              Price={Card[4].Price}
              Content={Card[4].Content} 
            ></CardJs>
            <CardJs  Image={Card[5].Image}
              Price={Card[5].Price}
       ...
       <div className='row3'>
            <CardJs  Image={Card[6].Image}
              Price={Card[6].Price}
              Content={Card[6].Content} 
            ></CardJs>
            <CardJs  Image={Card[7].Image}
              Price={Card[7].Price}
              Content={Card[7].Content} 
            ></CardJs>
            <CardJs  Image={Card[8].Image}
              Price={Card[8].Price}
